...
define(['./workbox-1da555b4'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\.(?:png|jpg|jpeg|gif|webp|svg)$/i, new workbox.CacheFirst({
